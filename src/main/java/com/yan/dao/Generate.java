...
//	}
    ...
    private boolean is0(int x, int y, User user, int[][] s, int xx, int yy) {
        set(x, y, user);
        s[x][y] = -1;
        if (get(x + 1, y, user)) {
            return true;
            ...
            if (xy1 != -1 && xy2 != -1) {
                if (s[xy1][xy2] != -1 && s[xy1][xy2] < 100 && s[xy1][xy2] != 0){
					...
					return is0(xy1, xy2, user, s, xx, yy);
				}
            }
            if (xy1 != -1 && xy4 < yy) {
                if (s[xy1][xy4] != -1 && s[xy1][xy4] < 100 && s[xy1][xy4] != 0){
					...
					return is0(xy1, xy4, user, s, xx, yy);
				}
            }
            if (xy3 < xx && xy2 != -1) {
                if (s[xy3][xy2] != -1 && s[xy3][xy2] < 100 && s[xy3][xy2] != 0){
					...
					return is0(xy3, xy2, user, s, xx, yy);
				}
            }
            if (xy3 < xx && xy4 < yy) {
                if (s[xy3][xy4] != -1 && s[xy3][xy4] < 100 && s[xy3][xy4] != 0){
					...
					return is0(xy3, xy4, user, s, xx, yy);
				}
            }
            return false;
        }
